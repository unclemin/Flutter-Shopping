class DetailsModel {
  ...
  DetailsModel.fromJson(Map<String, dynamic> json) {
    ...
    data = json['data'] != null ? new DetaulsGoodsData.fromJson(json['data']) : null;
  }
...
class DetaulsGoodsData {
  GoodInfo goodInfo;
  List<GoodComments> goodComments;
  AdvertesPicture advertesPicture;

  DetaulsGoodsData({this.goodInfo, this.goodComments, this.advertesPicture});

  DetaulsGoodsData.fromJson(Map<String, dynamic> json) {
